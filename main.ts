...
let question2 = await inquirer.prompt([
  {
    ...
    type: "list",
    message:
      "What is the data type of the variable name in the following code: let name = John?",
...
let question3 = await inquirer.prompt([
  {
    ...
    type: "list",
    message:
      "Which variable declaration allows a value to be changed later in the code?",
...
let question4 = await inquirer.prompt([
  {
    ...
    type: "list",
    message:
      "What is the data type of the variable age in the following code: let age = 25?",
...
let question5 = await inquirer.prompt([
  {
    ...
    type: "list",
    message:
      "Which data type is used to represent true or false values in most programming languages?",
